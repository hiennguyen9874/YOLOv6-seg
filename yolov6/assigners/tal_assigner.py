...
class TaskAlignedAssigner(nn.Module):
    ...
    @torch.no_grad()
    def forward(self, pd_scores, pd_bboxes, anc_points, gt_labels, gt_bboxes, mask_gt, gt_segmasks):
    ...
    def get_targets(self, gt_labels, gt_bboxes, target_gt_idx, fg_mask, gt_segmasks):
