            ...
            for i in range(self.nl):
                ...
                if self.export:
                    ...
                    seg_conf_list_af.append(
                        torch.cat([proto_no, seg_output_af.reshape([b, 67, l])], axis=1)
                    )  # [which_proto, (32...)]
...
class Proto(nn.Module):
    ...
    def __init__(
        self, num_layers, channels_list, pos, c_=256, c2=64, scale_factor=2
...
def build_effidehead_layer(
    channels_list, num_anchors, num_classes, reg_max=16, num_layers=3, num_masks=67, fuse_ab=False
):
