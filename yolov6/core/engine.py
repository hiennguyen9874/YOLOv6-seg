...
class Trainer:
        ...
        with amp.autocast(enabled=self.device != "cpu"):
            ...
            if self.args.distill:
                ...
                total_loss_ab, loss_items_ab = self.compute_loss_ab(
                    (preds[0], preds[1], preds[2], preds[6]),
                    targets,
                    epoch_num,
                    step_num,
                    batch_height,
    ...
    def eval_model(self):
        ...
        LOGGER.info(
            f"Epoch: {self.epoch} | box_mAP@0.5: {results[0]} | box_mAP@0.50:0.95: {results[1]} | mask_mAP@0.5: {results[2]} | mask_mAP@0.50:0.95: {results[3]}"
        )
