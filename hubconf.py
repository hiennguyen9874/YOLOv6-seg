...
def visualize_detections(
    image, boxes, classes, scores, min_score=0.4, figsize=(16, 16), linewidth=2, color="lawngreen"
):
...
class Detector(DetectBackend):
    ...
    def show_predict(
        self, img_path, min_score=0.5, figsize=(16, 16), color="lawngreen", linewidth=2
    ):
...
def create_model(
    ...
    return Detector(
        str(PATH_YOLOv6 / "weights") + f"/{model_name}.pt",
        class_names,
        device,
        img_size=img_size,
