...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--calib-weights", type=str, default="./yolov6s_reopt_calib.pt", help="calib weights path"
    )
    ...
    parser.add_argument(
        "--conf", type=str, default="../../configs/repopt/yolov6s_opt_qat.py", help="model config"
    )
    parser.add_argument("--export-batch-size", type=int, default=None, help="export batch size")
    parser.add_argument("--inplace", action="store_true", help="set Detect() inplace=True")
    parser.add_argument("--device", default="0", help="cuda device, i.e. 0 or 0, 1, 2, 3 or cpu")
    parser.add_argument(
        "--sensitivity-file", type=str, default=None, help="quantization sensitivity file"
    )
    ...
    if args.export_batch_size is None:
        ...
        export_file = args.weights.replace(
            ".pt", "_partial_bs{}.onnx".format(args.export_batch_size)
        )  # filename
        torch.onnx.export(
            model_ptq,
            img,
